...
def main():
    ...
    argparse.add_argument("--cfg",default="D:\\onnx\\torch_onnx\\weight\\yolov3_batch_2.cfg")
    argparse.add_argument("--weights",default="D:\\onnx\\torch_onnx\\weight\\yolov3.weights")
    argparse.add_argument("--out",default="D:\\onnx\\torch_onnx\\weight\\yolov3_batch_2.onnx")
