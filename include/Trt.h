...
public:
    ...
    void SetMaxBatchSize(int max_batch);
...
public:
    ...
    nvinfer1::ICudaEngine* mPreprocessorEngine = nullptr;
    nvinfer1::IExecutionContext* mPreprocessorContext = nullptr;
